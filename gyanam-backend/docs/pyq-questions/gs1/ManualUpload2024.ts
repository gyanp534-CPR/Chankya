...
Statement-I:
The Indian Flying Fox is placed under 'vermin' category in the Wild Life (Protection) Act, 1972.
...
(a) It is a platform for accelerating the transition toward food and water systems that are net-zero carbon, nature-positive and that aims to increase farmer resilience.
...
Which one of the following shows a unique relationship with an insect that has evolved with it and that is the only insect that can pollinate this tree?
...
2. For wholly owned banking subsidiaries in India, at least 50% of the board members should be Indians.
...
Statement-I:
Recently, Venezuela has achieved a rapid recovery from its economic crisis and succeeded in preventing its people from fleeing/migrating to other countries.
