...
2. Dated securities issued at market-related rates in auction form a large component of internal debt.
...
4. In India, the Parliament is vested with the powers to make law on Contempt of Court.
...
3. A Constitution Amendment Bill must be passed by both Lok Sabha and the Rajya Sabha by a special majority and there is no provision for joint sitting.
...
1. Nanda Barwa - Garhwal Himalaya
...
The term 'Levant' often heard in the news roughly corresponds to which of the following region?
...
1. SaaS buyers can customize the user interface and can change the data fields.
...
(b) Wing of 'Intergovernmental Panel on Climate Change'
...
1. The 24-hour mean of PM2.5 should not exceed 15 ug/m3 and annual mean of PM10 should not exceed 5 ug/m3.
...
'Bioremediation technology' is talked about in which one of the following situations?
...
3. It hears any objection to the Government notification relating to acquisition of coal-bearing areas.
...
(a) Sangam poems are devoid of any references to material culture.
(b) The social classification of Varna was known to Sangam poets.
(c) Sangam poems have no references to warrior ethics.
