Paste CSAT 2017 questions here.
Directions for the following 8 (eight) items

Read the following eight passages and answer the items that follow the passages. Your answers should be based on the passages only.
...
(a) The ideas of purity and pollution are so deep-rooted that they cannot be removed
...
By 2020, when the global economy is expected to run short of 56 million young people, India, with its youth surplus of 47 million, could fill the gap. It is in this context that labour reforms are often cited as the way to unlock double-digit growth in India. In 2014, India’s labour force was estimated to be about 40 per cent of the population, but 93 per cent of this force was in the unorganized sector. Over the last decade, the compound annual growth rate (CAGR) of employment has slowed to 0.5 per cent, with about 14 million jobs created during last year when the labour force increased by about 15 million.

6.

Which of the following is the most rational inference from the above passage?

(a) India must control its population growth to reduce unemployment
...
(d) India is capable of supplying skilled young people to other countries
...
Four tests—Physics, Chemistry, Mathematics and Biology—are to be conducted on four consecutive days, not necessarily in the same order.

Physics test is held before the test which is conducted after Biology
...
Three pillars X, Y and Z of different heights. Spiders A, B and C climb:

A: +6 cm, slips 1 cm → net 5 cm

B: +7 cm, slips 3 cm → net 4 cm

C: +6.5 cm, slips 2 cm → net 4.5 cm

Each takes 40 chances to reach top. Find height of shortest pillar.
...
(a) Individual good only
(b) Social good only
(c) Both individual and social good
(d) Individual good devoid of social well-being

18.

15 students failed in a class of 52. Merit list after removing failures → Ramesh is 22nd from top. What is his position from bottom?
...
Gopal sells at 10% profit, buys back at 10% loss. Net result?
...
Read the following seven passages and answer the items that follow the passages. Your answers to these items should be based on the passages only.
...
21. The challenge the author of the above passage throws to the public is to achieve
...
22. In the light of the above passage, the nature of General Will is best described as
...
People always see leisure time as a gift and use it for acquiring more material possessions.

Use of leisure by some people to produce new and original things has been the chief source of human progress.
...
A study of the famous battles of history would help us understand the modern warfare.

Studying the history is essential for anyone who aspires to be a leader.
...
29. In a group of six women, there are four tennis players, four postgraduates in Sociology, one postgraduate in Commerce and three bank employees. Vimala and Kamala are the bank employees while Amala and Komala are unemployed. Komala and Nirmala are among the tennis players. Amala, Kamala, Komala and Nirmala are postgraduates in Sociology of whom two are bank employees. If Shyamala is a postgraduate in Commerce, who among the following is both a tennis player and a bank employee?
(a) Amala
(b) Komala
(c) Nirmala
(d) Shyamala
...
31. A watch loses 2 minutes in every 24 hours while another watch gains 2 minutes in every 24 hours. At a particular instant, the two watches showed an identical time. Which of the following statements is correct if 24-hour clock is followed?
...
32. In a city, 12% of households earn less than ₹30,000 per year, 6% households earn more than ₹2,00,000 per year, 22% households earn more than ₹1,00,000 per year and 990 households earn between ₹30,000 and ₹1,00,000 per year. How many households earn between ₹1,00,000 and ₹2,00,000 per year?
(a) 250
(b) 240
(c) 230
(d) 225

33. A clock strikes once at 1 o’clock, twice at 2 o’clock and thrice at 3 o’clock, and so on. If it takes 12 seconds to strike at 5 o’clock, what is the time taken by it to strike at 10 o’clock?
(a) 20 seconds
(b) 24 seconds
(c) 28 seconds
(d) 30 seconds
...
35. There are thirteen 2-digit consecutive odd numbers. If 39 is the mean of the first five such numbers, then what is the mean of all the thirteen numbers?
(a) 47
(b) 49
(c) 51
(d) 45

36. Six boys A, B, C, D, E and F play a game of cards. Each has a pack of 10 cards. F borrows 2 cards from A and gives away 5 to C who in turn gives 3 to B while B gives 6 to D who passes on 1 to E. Then the number of cards possessed by D and E is equal to the number of cards possessed by
(a) A, B and C
(b) B, C and F
(c) A, B and F
(d) A, C and F

37. There is a milk sample with 50% water in it. If 1/3rd of this milk is added to equal amount of pure milk, then water in the new mixture will fall down to
(a) 25%
(b) 30%
(c) 35%
(d) 40%

38. There are 4 horizontal and 4 vertical lines, parallel and equidistant to one another on a board. What is the maximum number of rectangles and squares that can be formed?
(a) 16
(b) 24
(c) 36
(d) 42

39. A freight train left Delhi for Mumbai at an average speed of 40 km/hr. Two hours later, an express train left Delhi for Mumbai, following the freight train on a parallel track at an average speed of 60 km/hr. How far from Delhi would the express train meet the freight train?
(a) 480 km
(b) 260 km
(c) 240 km
(d) 120 km

40. In a test, Randhir obtained more marks than the total marks obtained by Kunal and Debu. The total marks obtained by Kunal and Shankar are more than those of Randhir. Sonal obtained more marks than Shankar. Neha obtained more marks than Randhir. Who amongst them obtained highest marks?
(a) Randhir
(b) Neha
(c) Sonal
...
Directions for the following 8 (eight) items:
Read the following seven passages and answer the items that follow the passages. Your answers should be based on the passages only.
...
41. Which one of the following is the best explanation of the above passage?
...
42. Which among the following is the most logical, rational and critical inference that can be made from the above passage?
...
43. Which among the following is the most logical and essential message conveyed by the above passage?
...
44. Which among the following is the most logical, rational and critical inference that can be made from the above passage?
...
45. Which among the following is the most logical and rational assumption that can be made from the above passage?
...
46. Which of the following is the most rational inference from the above passage?
...
They are not hazardous to human health.

They are persistent in environment.

They are essential to maintain the biodiversity of any ecosystem.
...
51. How many numbers are there between 99 and 1000 such that the digit 8 occupies the units place?
(a) 64
(b) 80
(c) 90
(d) 104
...
53. The age of Mr. X last year was the square of a number and it would be the cube of a number next year. What is the least number of years he must wait for his age to become the cube of a number again?
(a) 42
(b) 38
(c) 25
(d) 16

54. P works thrice as fast as Q, whereas P and Q together can work four times as fast as R. If P, Q and R together work on a job, in what ratio should they share the earnings?
(a) 3 : 1 : 1
(b) 3 : 2 : 4
(c) 4 : 3 : 4
(d) 3 : 1 : 4

55. Consider the following relationships among members of a family of six persons A, B, C, D, E and F:
...
56. A bag contains 20 balls. 8 balls are green, 7 are white and 5 are red. What is the minimum number of balls that must be picked up from the bag blindfolded (without replacing any of it) to be assured of picking at least one ball of each colour?
(a) 17
(b) 16
(c) 13
(d) 11

57. If 2 boys and 2 girls are to be arranged in a row so that the girls are not next to each other, how many possible arrangements are there?
(a) 3
(b) 6
(c) 12
(d) 24

58. The outer surface of a 4 cm × 4 cm × 4 cm cube is painted completely in red. It is sliced parallel to the faces to yield sixty four 1 cm × 1 cm × 1 cm small cubes. How many small cubes do not have painted faces?
(a) 8
(b) 16
(c) 24
(d) 36
...
60. In a certain code, ‘256’ means ‘red colour chalk’, ‘589’ means ‘green colour flower’ and ‘254’ means ‘white colour chalk’. The digit in the code that indicates ‘white’ is
(a) 2
(b) 4
(c) 5
(d) 8
...
An air quality index (AQI) is a way to combine measurements of multiple air pollutants into a single number or rating. This index is ideally kept constantly updated and available in different places. The AQI is most useful when lots of pollution data are being gathered and when pollution levels are normally, but not always, low. In such cases, if pollution levels spike for a few days, the public can quickly take preventive action (like staying indoors) in response to an air quality warning. Unfortunately, that is not urban India. Pollution levels in many large Indian cities are so high that they remain well above any health or regulatory standard for large part of the year. If our index stays in the Red/Dangerous region day after day, there is not much anyone can do, other than getting used to ignoring it.

61. Which among the following is the most logical and rational inference that can be made from the above passage?
...
62. Which among the following is the most logical and rational inference that can be made from the above passage?
...
63. Which among the following is the most logical and rational inference that can be made from the above passage?
...
64. Which among the following is the most logical and rational inference that can be made from the above passage?
...
65. Which among the following is the most logical corollary to the above passage?
...
66. Which one of the following views corroborates the above statement?
...
68. The average rainfall in a city for the first four days was recorded to be 0.40 inch. The rainfall on the last two days was in the ratio of 4 : 3. The average of six days was 0.50 inch. What was the rainfall on the fifth day?
(a) 0.60 inch
(b) 0.70 inch
(c) 0.80 inch
(d) 0.90 inch
...
70. To which city does the Lecturer specialized in Economics belong?
(a) Hyderabad
(b) Mumbai
...
72. In a school, there are five teachers A, B, C, D and E. A and B teach Hindi and English. C and B teach English and Geography. D and A teach Mathematics and Hindi. E and B teach History and French. Who teaches maximum number of subjects?
(a) A
(b) B
(c) D
(d) E

73. A 2-digit number is reversed. The larger of the two numbers is divided by the smaller one. What is the largest possible remainder?
(a) 9
(b) 27
(c) 36
(d) 45

74. The monthly incomes of X and Y are in the ratio of 4 : 3 and their monthly expenses are in the ratio of 3 : 2. However, each saves ₹ 6,000 per month. What is their total monthly income?
(a) ₹ 28,000
(b) ₹ 42,000
(c) ₹ 56,000
(d) ₹ 84,000

75. Two walls and a ceiling of a room meet at right angles at a point P. A fly is in the air 1 m from one wall, 8 m from the other wall and 9 m from the point P. How many meters is the fly from the ceiling?
(a) 4
(b) 6
(c) 12
(d) 15
...
Eight railway stations A, B, C, D, E, F, G and H are connected either by two-way passages or one-way passages.

One-way passages are from C to A, E to G, B to F, D to H, G to C, E to C and H to G.

Two-way passages are between A and E, G and B, F and D, and E and D.

76. While travelling from C to H, which one of the following stations must be passed through?
(a) G
(b) E
(c) D
(d) F

77. In how many different ways can a train travel from F to A without passing through any station more than once?
(a) 1
(b) 2
(c) 3
(d) 4

78. If the route between G and C is closed, which one of the following stations need not be passed through while travelling from H to C?
(a) E
(b) D
(c) A
(d) B

79. There are certain 2-digit numbers. The difference between the number and the one obtained on reversing it is always 27. How many such maximum 2-digit numbers are there?
(a) 3
(b) 4
(c) 5
(d) None of the above

80. What is the total number of digits printed, if a book containing 150 pages is to be numbered from 1 to 150?
(a) 262
(b) 342
(c) 360
(d) 450
